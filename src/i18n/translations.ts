export const translations = {
  en: {
    ...
    upperBound: 'Upper Bound for π',
    explanation: 'Explanation',
    piExplanation: 'By inscribing regular polygons in a circle of radius 1, we can approximate π. As the number of sides increases, the perimeter of the polygon approaches the circumference of the circle (2π). This gives us an upper bound for π.'
  },
  zh: {
    ...
    upperBound: 'π的上限',
    explanation: '说明',
    piExplanation: '通过在半径为1的圆中内接正多边形，我们可以近似计算π。随着边数的增加，多边形的周长会越来越接近圆的周长(2π)。这给出了π的一个上限。'
  }
};